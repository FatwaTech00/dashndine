  ...
  return (
    <div className='flex justify-center items-center h-screen '>
      ...
      '>
        ...
        <div className='info absolute grid grid-cols-3 px-20 bg-white w-[920px] h-[292px] -z-1 drop-shadow-2xl -bottom-[340px] left-56 rounded-2xl text-center items-center'>
